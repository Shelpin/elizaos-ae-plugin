...
const getAex141OwnedTokensOperationSpec = {
  ...
  queryParameters: [Parameters.limit, Parameters.direction, Parameters.contract],
...
const getAccountDexSwapsOperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.Paths1Ceolv9V3AccountsAccountIdDexSwapsGetResponses200ContentApplicationJsonSchema
    },
    400: {
      bodyMapper: Mappers.ErrorResponse,
      isError: true
...
const getAccountActivitiesOperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.Paths1Opead5V3AccountsIdActivitiesGetResponses200ContentApplicationJsonSchema
    },
    400: {
      bodyMapper: Mappers.ErrorResponse,
      isError: true
  ...
  queryParameters: [Parameters.limit, Parameters.ownedOnly, Parameters.typeParam, Parameters.scope, Parameters.direction2],
...
const getAccountPointeesOperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.Paths1Gc4HwtV3AccountsIdNamesPointeesGetResponses200ContentApplicationJsonSchema
    },
    404: {
...
const getAccountTransactionsCountOperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.PathsLv15NfV3TransactionsCountIdGetResponses200ContentApplicationJsonSchema
    },
    400: {
      bodyMapper: Mappers.ErrorResponse,
      isError: true
...
const getSortedAex141ContractsOperationSpec = {
  ...
  queryParameters: [Parameters.limit, Parameters.direction3, Parameters.by, Parameters.prefix, Parameters.exact],
...
const getAex141TokenOwnerOperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.Paths1Fbvaw8V3Aex141ContractidTokensTokenidGetResponses200ContentApplicationJsonSchema
    },
    400: {
      bodyMapper: Mappers.ErrorResponse,
      isError: true
...
const getAex141ContractTransfersOperationSpec = {
  ...
  queryParameters: [Parameters.limit, Parameters.direction7, Parameters.fromParam, Parameters.to],
  urlParameters: [Parameters.$host, Parameters.contractId],
  headerParameters: [Parameters.accept],
  serializer
};
...
const getSortedAex9TokensOperationSpec = {
  ...
  queryParameters: [Parameters.limit, Parameters.prefix, Parameters.exact, Parameters.direction8, Parameters.by1],
  urlParameters: [Parameters.$host],
  headerParameters: [Parameters.accept],
  serializer
};
...
const getAex9ContractBalancesOperationSpec = {
  ...
  queryParameters: [Parameters.limit, Parameters.direction9, Parameters.by2, Parameters.blockHash],
  urlParameters: [Parameters.$host, Parameters.contractId],
  headerParameters: [Parameters.accept],
  serializer
};
...
const getAex9ContractAccountBalanceHistoryOperationSpec = {
  ...
  queryParameters: [Parameters.limit, Parameters.scope, Parameters.direction10],
  urlParameters: [Parameters.$host, Parameters.accountId, Parameters.contractId],
  headerParameters: [Parameters.accept],
  serializer
};
...
const getChannelsOperationSpec = {
  ...
  queryParameters: [Parameters.limit, Parameters.scope, Parameters.direction11, Parameters.state],
  urlParameters: [Parameters.$host],
  headerParameters: [Parameters.accept],
  serializer
};
...
const getContractLogsOperationSpec = {
  ...
  queryParameters: [Parameters.limit, Parameters.scope, Parameters.contractId1, Parameters.event, Parameters.functionParam, Parameters.functionPrefix, Parameters.data, Parameters.aexnArgs, Parameters.direction13],
  urlParameters: [Parameters.$host],
  headerParameters: [Parameters.accept],
  serializer
};
...
const getNamesOperationSpec = {
  ...
  queryParameters: [Parameters.limit, Parameters.prefix, Parameters.by2, Parameters.ownedBy, Parameters.state1, Parameters.direction18],
  urlParameters: [Parameters.$host],
  headerParameters: [Parameters.accept],
  serializer
};
...
const getOraclesOperationSpec = {
  ...
  queryParameters: [Parameters.limit, Parameters.scope, Parameters.state1, Parameters.direction25],
  urlParameters: [Parameters.$host],
  headerParameters: [Parameters.accept],
  serializer
};
...
const getBlocksStatsOperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.PathsJd68YV3StatisticsBlocksGetResponses200ContentApplicationJsonSchema
    },
    400: {
      bodyMapper: Mappers.ErrorResponse,
      isError: true
  ...
  queryParameters: [Parameters.limit, Parameters.intervalBy, Parameters.minStartDate, Parameters.maxStartDate, Parameters.typeParam1, Parameters.direction26],
  urlParameters: [Parameters.$host],
  headerParameters: [Parameters.accept],
  serializer
};
const getDeltaStatsOperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.PathsQtodvgV3DeltastatsGetResponses200ContentApplicationJsonSchema
    },
    400: {
      bodyMapper: Mappers.ErrorResponse,
      isError: true
...
const getMinerStatsOperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.PathsZ2B507V3MinerstatsGetResponses200ContentApplicationJsonSchema
    },
    400: {
      bodyMapper: Mappers.ErrorResponse,
      isError: true
...
const getNamesStatsOperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.PathsD2HmjxV3StatisticsNamesGetResponses200ContentApplicationJsonSchema
    },
    400: {
      bodyMapper: Mappers.ErrorResponse,
      isError: true
  ...
  queryParameters: [Parameters.limit, Parameters.minStartDate, Parameters.maxStartDate, Parameters.intervalBy1, Parameters.direction29],
  urlParameters: [Parameters.$host],
  headerParameters: [Parameters.accept],
  serializer
};
const getTotalStatsOperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.PathsFrvc1LV3TotalstatsGetResponses200ContentApplicationJsonSchema
    },
    400: {
      bodyMapper: Mappers.ErrorResponse,
      isError: true
...
const getTransactionsStatsOperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.Paths150Ou6YV3StatisticsTransactionsGetResponses200ContentApplicationJsonSchema
    },
    400: {
      bodyMapper: Mappers.ErrorResponse,
      isError: true
  ...
  queryParameters: [Parameters.limit, Parameters.minStartDate, Parameters.maxStartDate, Parameters.intervalBy2, Parameters.txType, Parameters.direction31],
  urlParameters: [Parameters.$host],
  headerParameters: [Parameters.accept],
  serializer
};
...
const getTransactionsOperationSpec = {
  ...
  queryParameters: [Parameters.limit, Parameters.contract, Parameters.scope, Parameters.typeParam2, Parameters.typeGroup, Parameters.account, Parameters.channel, Parameters.oracle, Parameters.senderId, Parameters.recipientId, Parameters.entrypoint, Parameters.direction32],
  urlParameters: [Parameters.$host],
  headerParameters: [Parameters.accept],
  serializer
};
