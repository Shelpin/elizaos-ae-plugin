...
export declare class Middleware extends coreClient.ServiceClient {
     ...
     * @param options The options parameters.
     */
    getAccountActivities(id: `ak_${string}`, options?: GetAccountActivitiesOptionalParams): Promise<GetAccountActivitiesResponse>;
    /**
     * Get account pointees
     * @param id The account that names point to Account address
     * @param options The options parameters.
     */
    getAccountPointees(id: `ak_${string}`, options?: GetAccountPointeesOptionalParams): Promise<GetAccountPointeesResponse>;
    /**
     * Get transactions count and its type for given aeternity ID.
     * @param id The ID of the address/name/oracle/etc Account address
     * @param options The options parameters.
     */
    getAccountTransactionsCount(id: `ak_${string}`, options?: GetAccountTransactionsCountOptionalParams): Promise<GetAccountTransactionsCountResponse>;
    /**
...
export declare const operationSpecs: readonly [coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec, coreClient.OperationSpec];
