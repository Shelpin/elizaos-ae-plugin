import { TxParams as TxParamsComplex, TxParamsAsync as TxParamsAsyncComplex, TxUnpacked as TxUnpackedComplex } from "./schema.js";
 ...
 * @category transaction builder
 */
type TxParamsNameUpdateTx2Type = TxParamsComplex & {
    tag: Tag.NameUpdateTx;
    version: 2;
};
/**
 * @category transaction builder
 */
export interface TxParamsNameUpdateTx2 extends TxParamsNameUpdateTx2Type {
}
/**
 * @category transaction builder
 */
type TxParamsAsyncNameUpdateTx2Type = TxParamsAsyncComplex & {
    tag: Tag.NameUpdateTx;
    version: 2;
};
/**
 * @category transaction builder
 */
export interface TxParamsAsyncNameUpdateTx2 extends TxParamsAsyncNameUpdateTx2Type {
}
/**
 * @category transaction builder
 */
type TxUnpackedNameUpdateTx2Type = TxUnpackedComplex & {
    tag: Tag.NameUpdateTx;
    version: 2;
};
/**
 * @category transaction builder
 */
export interface TxUnpackedNameUpdateTx2 extends TxUnpackedNameUpdateTx2Type {
}
/**
 * @category transaction builder
 */
 ...
 * @category transaction builder
 */
export type TxParams = TxParamsSignedTx1 | TxParamsSpendTx1 | TxParamsNamePreclaimTx1 | TxParamsNameClaimTx2 | TxParamsNameUpdateTx1 | TxParamsNameUpdateTx2 | TxParamsNameTransferTx1 | TxParamsNameRevokeTx1 | TxParamsContractCreateTx1 | TxParamsContractCallTx1 | TxParamsOracleRegisterTx1 | TxParamsOracleExtendTx1 | TxParamsOracleQueryTx1 | TxParamsOracleResponseTx1 | TxParamsChannelCreateTx2 | TxParamsChannelCloseMutualTx1 | TxParamsChannelCloseSoloTx1 | TxParamsChannelSlashTx1 | TxParamsChannelDepositTx1 | TxParamsChannelWithdrawTx1 | TxParamsChannelSettleTx1 | TxParamsChannelForceProgressTx1 | TxParamsChannelOffChainTx2 | TxParamsChannelSnapshotSoloTx1 | TxParamsGaAttachTx1 | TxParamsGaMetaTx2 | TxParamsPayingForTx1;
/**
 * @category transaction builder
 */
export type TxParamsAsync = TxParamsAsyncSignedTx1 | TxParamsAsyncSpendTx1 | TxParamsAsyncNamePreclaimTx1 | TxParamsAsyncNameClaimTx2 | TxParamsAsyncNameUpdateTx1 | TxParamsAsyncNameUpdateTx2 | TxParamsAsyncNameTransferTx1 | TxParamsAsyncNameRevokeTx1 | TxParamsAsyncContractCreateTx1 | TxParamsAsyncContractCallTx1 | TxParamsAsyncOracleRegisterTx1 | TxParamsAsyncOracleExtendTx1 | TxParamsAsyncOracleQueryTx1 | TxParamsAsyncOracleResponseTx1 | TxParamsAsyncChannelCreateTx2 | TxParamsAsyncChannelCloseMutualTx1 | TxParamsAsyncChannelCloseSoloTx1 | TxParamsAsyncChannelSlashTx1 | TxParamsAsyncChannelDepositTx1 | TxParamsAsyncChannelWithdrawTx1 | TxParamsAsyncChannelSettleTx1 | TxParamsAsyncChannelForceProgressTx1 | TxParamsAsyncChannelOffChainTx2 | TxParamsAsyncChannelSnapshotSoloTx1 | TxParamsAsyncGaAttachTx1 | TxParamsAsyncGaMetaTx2 | TxParamsAsyncPayingForTx1;
/**
 * @category transaction builder
 */
export type TxUnpacked = TxUnpackedSignedTx1 | TxUnpackedSpendTx1 | TxUnpackedNamePreclaimTx1 | TxUnpackedNameClaimTx2 | TxUnpackedNameUpdateTx1 | TxUnpackedNameUpdateTx2 | TxUnpackedNameTransferTx1 | TxUnpackedNameRevokeTx1 | TxUnpackedContractCreateTx1 | TxUnpackedContractCallTx1 | TxUnpackedOracleRegisterTx1 | TxUnpackedOracleExtendTx1 | TxUnpackedOracleQueryTx1 | TxUnpackedOracleResponseTx1 | TxUnpackedChannelCreateTx2 | TxUnpackedChannelCloseMutualTx1 | TxUnpackedChannelCloseSoloTx1 | TxUnpackedChannelSlashTx1 | TxUnpackedChannelDepositTx1 | TxUnpackedChannelWithdrawTx1 | TxUnpackedChannelSettleTx1 | TxUnpackedChannelForceProgressTx1 | TxUnpackedChannelOffChainTx2 | TxUnpackedChannelSnapshotSoloTx1 | TxUnpackedGaAttachTx1 | TxUnpackedGaMetaTx2 | TxUnpackedPayingForTx1;
export {};
