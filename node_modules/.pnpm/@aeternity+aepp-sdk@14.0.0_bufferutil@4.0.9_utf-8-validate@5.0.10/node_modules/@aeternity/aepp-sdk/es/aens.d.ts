...
interface NameClaimOptions extends BuildTxOptions<Tag.NameClaimTx, 'accountId' | 'nameSalt' | 'name'>, Optional<SendTransactionOptions, 'onAccount' | 'onNode'> {
}
/**
 * @category AENS
 * @example
...
export default class Name {
     ...
     * ```
     */
    preclaim(options?: NamePreclaimOptions): ReturnType<typeof sendTransaction>;
    /**
     * Bid to name auction
