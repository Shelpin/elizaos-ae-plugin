...
var AeternityWalletProvider = class {
  ...
  static async generateKeyPair(password) {
    try {
      const { generateKeyPair } = __require("@aeternity/aepp-sdk");
...
// src/actions/transferAe.ts
var transferAeSchema = z2.object({
  // Recipient address
  recipient: z2.string().min(1),
  // Amount to transfer
...
// src/actions/tipTelegramUser.ts
var tipTelegramUserSchema = z3.object({
  ...
  contributionDescription: z3.string().optional(),
  // Optional message to include with the tip
  message: z3.string().optional(),
  // Optional transaction parameters
  options: z3.object({
    fee: z3.string().optional()
  }).optional(),
