...
__export(index_exports, {
  ...
  aeternityEnvSchema: () => aeternityEnvSchema,
  aeternityPlugin: () => aeternityPlugin,
  analyzeContributionAction: () => analyzeContributionAction,
  callContractAction: () => callContractAction,
  env: () => env,
  generateKeyPairAction: () => generateKeyPairAction,
  processAddressRegistrationAction: () => processAddressRegistrationAction,
  tipTelegramUserAction: () => tipTelegramUserAction,
  transferAeAction: () => transferAeAction
});
...
var aeternityEnvSchema = z.object({
...
var TransactionType = /* @__PURE__ */ ((TransactionType2) => {
  TransactionType2["SPEND"] = "spend";
  TransactionType2["CONTRACT_CREATE"] = "contractCreate";
  TransactionType2["CONTRACT_CALL"] = "contractCall";
  TransactionType2["NAME_PRECLAIM"] = "namePreclaim";
  TransactionType2["NAME_CLAIM"] = "nameClaim";
  TransactionType2["NAME_UPDATE"] = "nameUpdate";
  TransactionType2["NAME_TRANSFER"] = "nameTransfer";
  TransactionType2["CHANNEL_CREATE"] = "channelCreate";
  return TransactionType2;
})(TransactionType || {});
var WalletSecurityLevel = /* @__PURE__ */ ((WalletSecurityLevel2) => {
  WalletSecurityLevel2["LOW"] = "low";
  WalletSecurityLevel2["MEDIUM"] = "medium";
  WalletSecurityLevel2["HIGH"] = "high";
  WalletSecurityLevel2["TEE"] = "tee";
  return WalletSecurityLevel2;
})(WalletSecurityLevel || {});
...
var AeternityWalletProvider = class {
  ...
  static async generateKeyPair(password) {
    const keyPair = (0, import_aepp_sdk.generateKeyPair)();
...
// src/actions/generateKeyPair.ts
var generateKeyPairSchema = z.object({
  ...
  securityLevel: z.enum([
    ...
    "high" /* HIGH */,
    "tee" /* TEE */
  ]).optional().default("high" /* HIGH */)
});
var generateKeyPair2 = async (input) => {
  try {
...
var generateKeyPairAction = {
  name: "GENERATE_KEY_PAIR",
  description: "Generate a secure Aeternity key pair with encryption",
  inputSchema: generateKeyPairSchema,
  execute: generateKeyPair2
};

// src/actions/callContract.ts
var callContractSchema = z.object({
  // Contract ID
...
var callContract = async (input, context) => {
  try {
...
var tipTelegramUserSchema = z.object({
...
var processAddressRegistrationSchema = z.object({
  // Telegram username
...
var analyzeContributionSchema = z.object({
...
var aeternityPlugin = {
  ...
  registerProviders: async (runtime) => {
  ...
  handleMessage: async (message, runtime) => {
    if (message.is_direct && typeof message.text === "string" && message.text.trim().startsWith("ak_")) {
      try {
